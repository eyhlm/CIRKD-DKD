...
class Trainer(object):
    ...
    def train(self):
        ...
        for iteration, (images, targets, _) in enumerate(self.train_loader):
            ...
            dkd_loss = self.criterion_dkd(s_outputs[0], t_outputs[0],targets)
            # print(dkd_loss)
            ...
            if iteration % log_per_iters == 0 and save_to_disk:
                logger.info(
                    ...
                    "|| Mini-batch p2p Loss: {:.4f} || Memory p2p Loss: {:.4f} || Memory p2r Loss: {:.4f} " \
                        "|| Cost Time: {} || Estimated Time: {} || dkd:{}".format(
                        ...
                        str(datetime.timedelta(seconds=int(time.time() - start_time))), eta_string, dkd_losses_reduced.item()))
