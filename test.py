    ...
    def eval(self):
        ...
        for i, (image, target, filename) in enumerate(self.val_loader):
            ...
            if self.args.save_pred:
                ...
                print(os.path.join(args.outdir, os.path.basename(os.path.splitext(filename[0][0])[0]) + '.png'))
                mask.save(os.path.join(args.outdir, os.path.basename(os.path.splitext(filename[0][0])[0]) + '.png'))
                # print('Save mask to ' + os.path.splitext(filename[0][0])[0] + '.png' + ' Successfully!')
